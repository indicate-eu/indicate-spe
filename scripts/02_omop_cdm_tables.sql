...
-- PostgreSQL version with reserved keyword fixes
-- Fix applied: "offset" quoted in NOTE_NLP table (line ~268)
-- For use with PostgreSQL init scripts in Docker

-- Set search path to cdm schema
...
-- CRITICAL FIX: "offset" is a PostgreSQL reserved keyword and must be quoted
...
-- ===================================================================
-- STANDARDIZED HEALTH ECONOMICS TABLES
-- ===================================================================
